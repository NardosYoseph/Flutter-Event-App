...
class LiveEventStream extends StatefulWidget {
  const LiveEventStream({Key? key}) : super(key: key);

  @override
  _LiveEventStreamState createState() => new _LiveEventStreamState();
}

class _LiveEventStreamState extends State<LiveEventStream>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          //     onSelected: (choice) => _onMenuSelected(choice, context), itemBuilder: (BuildContext context) {  },
